...
<!-- Main -->
        <main class="z-depth-3 container card-panel white-text center-align row">
            ...
            <section>
                ...
                ?>
                    <a class="white-text center-align col s8 offset-s2 card flow-text indigo darken z-depth-5" href="<?php echo $All[$i]; ?>"><?php echo $All[$i]; ?></a>
                <?php 
                         }
                     $i++;
                 }
