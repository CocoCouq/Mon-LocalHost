            ...
            <section class="col s12">
                ...
                <article class="row section valign-wrapper">
                    <blockquote class="col s6 offset-s1">
                        Ce site reprend une partie des exercices de mes études afin d'en optimiser la présentation en évaluation.
                ...
                <nav id="navBar" class="z-depth-2 black navbar-fixed" role="navigation">
                    <div class="nav-wrapper row">
                        ...
                        <ul class="right hide-on-med-and-down col offset-s1">
                            <li><a class="liensMenu" href="CDA/index.php">CDA</a></li>
                            <li><a class="liensMenu" href="Jarditou-Bootstrap/Views/Home.php" target="_blank">Jarditou</a></li>
                         </ul>
                    </div>
                </nav>
<!-- M-S Navbar -->
                <ul class="sidenav" id="mobile-demo">
                    <li><a href="#">Host</a></li>
                    <li><a href="CDA/index.php">CDA</a></li>
